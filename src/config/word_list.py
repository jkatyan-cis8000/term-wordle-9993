"""Daily word list for the game."""

from typing import List

# 2000+ common 5-letter English words
# This list will be used to select the daily word
DAILY_WORD_LIST: List[str] = [
    ...
    "plate", "power", "radio", "river", "robot", "shoe", "skirt", "snake",
    "space", "spoon", "star", "storm", "sweet", "table", "tiger", "tooth",
    "track", "train", "truck", "water", "watch", "whale", "world", "write",
    "youth", "zebra", "abuse", "actor", "adopt", "adult", "after", "again",
    ...
    "bases", "basic", "basis", "began", "begin", "begun", "being", "below",
    "bench", "billy", "birth", "black", "blame", "blind", "block", "blood",
    "board", "boost", "booth", "bound", "brain", "brand", "bread", "break",
    "brick", "bring", "broad", "broke", "brown", "build", "built", "buyer",
    "cable", "calm", "canal", "candy", "cargo", "carry", "catch", "cause",
    "chain", "chair", "chart", "chase", "cheap", "check", "chest", "chief",
    "child", "china", "choice", "church", "civic", "civil", "claim", "class",
    ...
    "long", "loose", "lower", "lucky", "lunch", "lying", "magic", "major",
    ...
    "rival", "river", "robot", "roger", "roman", "rough", "round", "route",
    ...
    "space", "spare", "speak", "speed", "spend", "spent", "spoke", "spot",
    "spouse", "spread", "spring", "square", "stage", "stand", "star",
    ...
    "wrote", "yield", "young", "youth", "aback", "abaft", "abase", "abash",
    "abate", "abaya", "abbey", "abbot", "abide", "abled", "abode", "abort",
    "about", "above", "abuse", "abyss", "acorn", "acrid", "actor", "acute",
    "adage", "adapt", "adept", "admin", "admit", "adopts", "adore", "adorn",
    "adult", "after", "again", "agape", "agate", "agent", "agile", "aging",
    "aglow", "agony", "agree", "ahead", "aisle", "alarm", "album", "alert",
    "algae", "alibi", "alien", "align", "alike", "alive", "allay", "alleg",
    "alley", "allot", "allow", "alloy", "aloft", "alone", "along", "aloof",
    "aloud", "alpha", "altar", "alter", "amass", "amaze", "amber", "amend",
    "amice", "amid", "amiss", "amity", "among", "ample", "amply", "amuse",
    "angel", "anger", "angle", "angry", "animal", "animate", "anime", "ankle",
    "annal", "annex", "annoy", "annul", "anode", "antic", "anvil", "aorta",
    "apart", "apex", "apish", "apron", "aptly", "arbor", "ardor", "arena",
    "argue", "arise", "armor", "armory", "aroma", "array", "arrest", "arrive",
    "arrow", "arson", "artly", "asleep", "aspect", "assay", "assent", "assert",
    "assess", "assets", "assign", "assist", "assume", "assure", "astir", "astound",
    "awake", "award", "aware", "awash", "awful", "awoke", "axial", "axiom",
    "axion", "azure", "back", "bade", "baker", "basal", "basic", "basis",
    "basks", "basso", "baste", "batch", "bath", "bathe", "baton", "batty",
    "bawdy", "bayou", "beach", "beads", "beaks", "beams", "beams", "beard",
    "beast", "beast", "beats", "beaux", "beady", "beak", "ball", "banal",
    "band", "bang", "bank", "barb", "bard", "bare", "bark", "barn", "barr",
    "base", "bash", "basic", "basil", "basin", "basis", "baste", "batch",
    "basic", "baton", "batty", "bawdy", "bayou", "beach", "beads", "beaks",
    "beams", "beard", "beast", "beats", "beaux", "beady", "beak", "ball",
    "banal", "band", "bang", "bank", "barb", "bard", "bare", "bark", "barn",
    "barr", "base", "bash", "basic", "basil", "basin", "basis", "baste",
    "batch", "basic", "baton", "batty", "bawdy", "bayou", "beach", "beads",
    "beaks", "beams", "beard", "beast", "beats", "beaux", "beady", "beak",
    "ball", "banal", "band", "bang", "bank", "barb", "bard", "bare", "bark",
    "barn", "barr", "base", "bash", "basic", "basil", "basin", "basis", "baste"
]
